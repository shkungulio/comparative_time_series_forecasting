...
required_pkgs <- c("flexdashboard", "tidyverse", "scales", "forecast", "shiny",
                   "quantmod", "xts", "zoo", "PerformanceAnalytics", "patchwork") 
...
# Best model per stock from the report (by RMSE):
# AAPL -> ARIMA, AMZN -> ARIMA, MSFT -> Naive, TSLA -> Naive
best_model_map <- tibble::tibble(
  ticker = c("AAPL","AMZN","MSFT","TSLA"),
  best_model = c("ARIMA","ARIMA","Naive","Naive")
)
...
sliderInput(
  ...
  min = 0, max = 120, value = 30, step = 20
)
